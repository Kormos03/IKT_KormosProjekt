...
exports.RegistComponent = void 0;
const react_1 = require("react");
const react_router_dom_1 = require("react-router-dom");
const StyledInput_1 = require("./StyledInput");
const GLOBAL_API_URL_1 = require("../../GLOBAL_API_URL");
const API_URL = GLOBAL_API_URL_1.GLOBAL_API_URL + '/users/regist';
function RegistComponent() {
    const [email, setEmail] = (0, react_1.useState)('');
    const [name, setName] = (0, react_1.useState)('');
    const [pass, setPass] = (0, react_1.useState)('');
    const [passAgain, setPassAgain] = (0, react_1.useState)('');
    const [registError, setRegistError] = (0, react_1.useState)('');
    ...
    <form>
        ...
        <StyledInput_1.StyledInput type="email" id="email" name="email" onChange={e => setEmail(e.currentTarget.value)} placeholder="kiss.jani@gmail.com"/><br />

        <label htmlFor="name">Teljes név</label><br />
        <StyledInput_1.StyledInput type="text" id="name" name="name" onChange={e => setName(e.currentTarget.value)} placeholder="Kiss János"/><br />
        ...
        <StyledInput_1.StyledInput type="password" id="password-again" name="password-again" onChange={e => setPassAgain(e.currentTarget.value)} placeholder="Jelszó újra"/><br />

        <button className="btn btn-primary btn-lg" type="submit" onClick={registration}>Regisztráció</button><br />

    </form><br />
    <react_router_dom_1.NavLink className="nav-link" to="/login">Van már fiókod? Jelentkezz be</react_router_dom_1.NavLink>
    <p>{registError}</p> 
    </div>;
}
exports.RegistComponent = RegistComponent;
//# sourceMappingURL=RegistComponent.js.map